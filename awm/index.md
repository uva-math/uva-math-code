...
<li>Faculty Mentors (AWM / Math Club committee): {% include person_info_email_only.html UVA_id="af7py" %}, {% include person_info_email_only.html UVA_id="brh5c" %}, {% include person_info_email_only.html UVA_id="sm4cw" %}, and {% include person_info_email_only.html UVA_id="rbh3vx" %}</li>
</ul>  
