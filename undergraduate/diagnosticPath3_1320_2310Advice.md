...
<p> Now that you've taken  <a href="https://math.virginia.edu/undergraduate/placement-files/diagnostic_1320_2310.html">the diagnostic</a> to decide between Math 1310 and Math 1320,  </p>
 ...
 <ul>
    <li> Grade diagnostic problems as either right or wrong using the <a href="https://math.virginia.edu/undergraduate/placement-files/ExamC_Solutions.pdf">Math 1320/2310 placement solutions (PDF)</a> (<a href="https://math.virginia.edu/undergraduate/placement-files/ExamC_Solutions.html">Math 1320/2310 placement solutions (HTML)</a>). If you arrived at an incorrect solution owing only to a careless arithmetic error, then count the solution as correct. </li>
