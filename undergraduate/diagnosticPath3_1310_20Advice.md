...
<p> Now that you've taken  <a href="https://math.virginia.edu/undergraduate/placement-files/diagnostic_1310_1320.html">the diagnostic</a> to decide between Math 1310 and Math 1320,  </p>
 ...
 <ul>
    <li> Grade diagnostic problems as either right or wrong using the <a href="https://math.virginia.edu/undergraduate/placement-files/ExamB_Solutions.pdf">Math 1310/1320 placement solutions (PDF)</a> (<a href="https://math.virginia.edu/undergraduate/placement-files/ExamB_Solutions.html">Math 1310/1320 placement solutions (HTML)</a>). If you arrived at an incorrect solution owing only to a careless arithmetic error, then count the solution as correct. </li>
