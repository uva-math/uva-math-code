...
<ul>
 <li> {% include course number=1140 %} </li>
 <li> {% include course number=1191 %}, {% include course number=1210 %}, {% include course number=1310 %} (collectively referred to as Calculus I) </li>
