...
Please click here: <a href="{{ site.url }}/undergraduate/docs/DSP-GMP Info Sheets_2015 1.pdf">Undergraduate Director&#39;s Summer Program (DSP)</a> (<a href="{{ site.url }}/undergraduate/docs/DSP-GMP Info Sheets_2015 1.html">Director’s Summer Program information (HTML)</a>).
