...
UVA undergraduates take part in the Putnam Competition and in several other national mathematics competitions and project contests each year. Dates, deadlines, and contacts are on the [competitions page]({{site.url}}/undergraduate/competitions/).

---

<h2 class="bodoni-h2">Math Club</h2>

The Undergraduate Math Club at University of Virginia is a weekly seminar and a club for students interested in mathematics and related areas. An up-to-date calendar of meetings is [here]({{site.url}}/seminars/mathclub/). The Math Club is a students' space having an official UVA CIO status (a student-led organization). This provides the Club with a student managing board which helps plan and organize events. 
