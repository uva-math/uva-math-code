...
// its modifications can be used for seminar pages
  var userEmail = [ //do not reorder as seminar links depend on this. This also has to match _data/seminars.yml
    ...
    "c_60f1de561954223e1933f83f3bfb2520fd742ca85cbd6a02dade97379ec7fad3@group.calendar.google.com",  // 16 - AMS chapter
...
//various seminar things
  function getSeminar(num)
  {
    ...
    if(num == 14) { return '<a href="{{site.url}}/ams_chapter/">AWM at UVA</a>'; }
    ...
    if(num == 16) { return '<a href="{{site.url}}/awm/calendar/">AMS Student Chapter</a>'; }
